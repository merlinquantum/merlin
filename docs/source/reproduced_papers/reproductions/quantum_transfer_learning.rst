...
The reproduced papers notebook provides a step-by-step walkthrough of all three examples, including
architecture diagrams for the dressed quantum circuit and CQ pipeline, training curves
and decision boundary visualisations for the spiral experiment, image prediction grids
for the Hymenoptera and CIFAR-10 experiments, and a full results summary comparing
reproduction results against the paper.
